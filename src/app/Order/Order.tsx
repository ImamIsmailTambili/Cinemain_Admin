                        ...
                        <tbody className="divide-y divide-slate-200">
                            {orders.data.map((order: any) => (
                                <tr key={order.id} className="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td className="px-3 md:px-6 py-4 text-xs md:text-sm  font-medium">{order.nomorKursi}</td>
                                    <td className="px-3 md:px-6 py-4 text-xs md:text-sm  font-medium">{formatRupiah(order.harga)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
